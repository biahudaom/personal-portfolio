            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>{` Hi! I'm Tran Kim Dat `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "A Front-end Developer", "Web Developer"]'><span className="wrap">{text}</span></span></h1>
